...
<div class="row">
   ...
   <div class="panel panel-card margin-b-30">
       ...
       <div class="panel-body">
           <form class="form-horizontal" method="post" id="create_sup" name="create_sup" action="functions/suppliers_functions.php" data-toggle="validator" novalidate="true">
           ...
           <div class="form-group">
               <div class="col-lg-offset-2 col-lg-10">
                   <button id="create_sup" name="create_sup" class="btn btn-sm btn-primary disabled" type="submit">Save</button>
               </div>
           </div>
